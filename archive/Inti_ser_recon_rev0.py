...
automatiquement
- ajout de sauvegarde png _protus avec flag disk_display
- ajout flag pour ne sauver que les fits finaux
- transfert lecture et calcul moyenne fichier ser dans inti_recon
...
#affiche un disque noir sur image aux seuils protus
disk_display=True
